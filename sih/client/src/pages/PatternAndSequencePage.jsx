...
import PatternAndSequence from '../games/pattern-and-sequence/PatternAndSequence';

export default function PatternAndSequencePage() {
  ...
  return (
    <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '16px 20px' }}>
      ...
      {/* Render the scoped Pattern & Sequence Game */}
      <PatternAndSequence />
    </div>
  );
}
